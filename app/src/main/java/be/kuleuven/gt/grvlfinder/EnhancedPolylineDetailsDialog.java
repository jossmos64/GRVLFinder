...
/**
 * Enhanced road details dialog with weather warnings
 */
    ...
    public static void show(Context context, PolylineResult polylineResult,
        ...
        if (weatherCalc != null && weatherCalc.hasWeatherData()) {
            dialog.setOnShowListener(dialogInterface -> {
                // You can add a button to the bottom sheet here if desired
                // For simplicity, we'll let users access weather via the main button
            });
        }
